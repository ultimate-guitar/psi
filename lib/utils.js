...
const humanizeTitleMap = {
  ...
  overall_category: 'Page Speed', // eslint-disable-line camelcase
  FIRST_CONTENTFUL_PAINT_MS: 'Content first paint',
  DOM_CONTENT_LOADED_EVENT_FIRED_MS: 'DOM content loaded'
};
